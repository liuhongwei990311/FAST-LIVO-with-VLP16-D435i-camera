...
set(MSG_I_FLAGS "-Ifast_livo:/SLAM_project/fast-livo_ws/src/FAST-LIVO/msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/SLAM_project/fast-livo_ws/src/FAST-LIVO/msg/Pose6D.msg" NAME_WE)
add_custom_target(_fast_livo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fast_livo" "/SLAM_project/fast-livo_ws/src/FAST-LIVO/msg/Pose6D.msg" ""
)

get_filename_component(_filename "/SLAM_project/fast-livo_ws/src/FAST-LIVO/msg/States.msg" NAME_WE)
add_custom_target(_fast_livo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fast_livo" "/SLAM_project/fast-livo_ws/src/FAST-LIVO/msg/States.msg" "std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/fast_livo)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/fast_livo\")")
  # install generated code
  install(
